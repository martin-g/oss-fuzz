...
# CIFUZZ is a env variable that set during CIFUZZ
if [[ -v CIFUZZ ]]; then
  ...
  for fuzzer in $(find $SRC/project-parent -name '*FuzzerTest.java'); do
...
# different build for local development environment
else
  cd project-parent
